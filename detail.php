        ...
        <div class="container">
          <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    <?php
                    $select_imgs = "SELECT * FROM images WHERE pro_id=".$pro_detail["id"];
                    $imgs_names = [];
                    $imgs = $conn->query($select_imgs)->fetch_all(MYSQLI_ASSOC);
                    foreach($imgs as $img) $imgs_names[] = $img["name"];
                    foreach($imgs_names as $name) {
                    ?>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                      <img class="w-100" src="admin/images/<?=$name?>" alt="...">
                    </div>
                  <?php } ?>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    ...
                    ?>
                    <a class="d-block"
                      href="admin/images/<?=$name?>"
                      data-lightbox="product" 
                      title="Product item 1">
                      <img class="img-fluid" src="admin/images/<?=$name?>" >
                    </a>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="col-lg-6">
              ...
              <p class="text-muted lead">$<?=$pro_detail["price"]?></p>
              <p class="text-small mb-4"><?=$pro_detail["description"]?></p>
              <div class="row align-items-stretch mb-4">
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ml-2" href="#"><?=$category?></a></li>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                ...
                <p class="text-muted text-small mb-0"><?=$pro_detail["description"]?></p>
              </div>
            </div>
