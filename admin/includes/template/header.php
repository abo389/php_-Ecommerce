        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTables" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Main Tables:</h6>
                        <a class="collapse-item" href="tables.php?name=products">Products</a>
                        ...
                        <a class="collapse-item" href="tables.php?name=gender">Gender</a>
                    </div>
                </div>
            </li>
